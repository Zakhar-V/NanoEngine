...
//!
inline auto begin(Json& _json)->decltype(_json.Begin()) { return _json.Begin(); }
//!
inline auto begin(const Json& _json)->decltype(_json.Begin()) { return _json.Begin(); }
//!
inline auto end(Json& _json)->decltype(_json.End()) { return _json.End(); }
//!
inline auto end(const Json& _json)->decltype(_json.End()) { return _json.End(); }
